...
class trainListAd extends StatefulWidget {
  const trainListAd({Key? key}) : super(key: key);

  @override
  State<trainListAd> createState() => _trainListAdState();
}

class _trainListAdState extends State<trainListAd> {
